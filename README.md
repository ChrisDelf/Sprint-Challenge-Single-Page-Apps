...
> Answer: - Allow for faster routing between views. Smoother Animations. Does not require a full web refresh.
- [ ] What does AJAX stand for? Asynchoronous JavaScript and XML
> Answer:
- [ ] What are `controlled components` in React?
> Answer: Using setState() to receive inputs from a form. This uses an eventHandler.
